...
# program release
openocd -f interface/stlink-v2.cfg -f target/stm32f4x.cfg -c "program ./Nucleo-F413ZH/build_release_boot/Nucleo-F413ZH.bin 0x08000000; reset run; exit;"

# program debug
openocd -f interface/stlink-v2.cfg -f target/stm32f4x.cfg -c "program ./Nucleo-F413ZH/build_debug_boot/Nucleo-F413ZH.bin 0x08000000; reset run; exit;"
*/
